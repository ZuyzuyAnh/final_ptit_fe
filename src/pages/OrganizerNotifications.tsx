...
const OrganizerNotifications = () => {
  ...
  const handleDelete = async () => {
    ...
    await safeRequest(async () => {
      await organizerNotificationApi.delete(deleteConfirm.notification_id);
  ...
  const handleSend = async () => {
    ...
    await safeRequest(async () => {
      const result = await organizerNotificationApi.send(
        sendConfirm.notification_id
      );
      toast.success(
  ...
  const handleCancel = async () => {
    ...
    await safeRequest(async () => {
      await organizerNotificationApi.cancel(cancelConfirm.notification_id);
